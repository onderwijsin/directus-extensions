...
**Expected:** Mouse coordinate logs stop printing.

**Actual:** Mouse coordinates continue to print after component is unmounted.

I was looking at how directives are implemented in VueUse and noticed that these aren't cleaned when
component unmounts.
