...
When Installing the Nuxt3 version based on documentation it fails due to a _'Conflicting peer
dependency'._ This happens on a clean `npx nuxi init`
...
npm install npm@7.0 -g rm -rf node_modules npm install
...
npx nuxi init testing cd testing npm install npm i -D @vueuse/nuxt @vueuse/core
...
npm ERR! Could not resolve dependency: npm ERR! dev @vueuse/core@"*" from the root project npm ERR!
npm ERR! Conflicting peer dependency: vue@2.6.14
