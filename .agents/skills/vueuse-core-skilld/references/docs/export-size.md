...
generated by export-size<br> version: 14.1.0<br> date: 2026-01-07T03:07:59.027Z

> Please note this is bundle size for each individual APIs (excluding Vue). Since we have a lot
> shared utilities underneath each function, importing two different functions does NOT necessarily
> mean the bundle size will be the sum of them (usually smaller). Depends on the bundler and
> minifier you use, the final result might vary, this list is for reference only.
