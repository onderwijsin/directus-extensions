...
Hello, everyone, I need the coordinates taken via the composable useGeolocation() in an API call I
make via useAsyncData(). The problem is that they are still undefined at that point. reproduction
link: https://stackblitz.com/edit/nuxt-starter-zb6l89?file=app.vue Does anyone have any idea how I
