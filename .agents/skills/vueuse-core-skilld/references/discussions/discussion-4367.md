...
The bundle size is the same. It's just that Vue has been moved from the optional PeerDependency of
`vue-demi` to dependencies, which causes this measure to be different.
