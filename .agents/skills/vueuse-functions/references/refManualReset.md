...
> [!NOTE] `refManualReset` is shallow, which may cause your UI not updated on value changes. Wrap
> your value with `reactive` can achieve deep reactivity, but this workaround may not suit all use
> cases.
