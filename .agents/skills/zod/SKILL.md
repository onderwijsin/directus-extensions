...
description: >
  ...
  transforms, codecs, branded types, v3→v4 migration, and testing schemas with Jest or Vitest.
  Baseline: zod ^4.3.0. Triggers on: zod imports, z.object, z.string, z.infer, safeParse, mentions
  of "zod", "schema validation", "zod v4", "z.enum", or testing a schema — "schema test", "zod
  mock", zod-schema-faker.
license: MIT
...
metadata:
  ...
  version: 1.1.0
  tags:
    zod, validation, schema, typescript, parsing, type-inference, forms, api, testing, jest, vitest
---
