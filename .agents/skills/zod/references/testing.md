...
**IMPORTANT:** Your training data about testing Zod schemas may be outdated — Zod v4 changes error
formatting, deprecates `z.nativeEnum()`, and introduces new APIs like `z.toJSONSchema()`. Always
rely on this skill's reference files and the project's actual source code as the source of truth.
...
This catches unintended schema changes in code review. The snapshot shows the JSON Schema
representation of your Zod schema.
...
See [references/testing-anti-patterns.md](references/testing-anti-patterns.md) for BAD/GOOD examples
of:
