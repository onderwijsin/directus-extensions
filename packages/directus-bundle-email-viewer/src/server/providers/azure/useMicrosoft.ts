import type { GetTokenOptions } from "@azure/identity";
import type { EndpointExtensionContext } from "@directus/extensions";
import type { TokenCredentialAuthenticationProviderOptions } from "@microsoft/microsoft-graph-client/authProviders/azureTokenCredentials";
import { ClientSecretCredential } from "@azure/identity";
import { Client } from "@microsoft/microsoft-graph-client";
import { TokenCredentialAuthenticationProvider } from "@microsoft/microsoft-graph-client/authProviders/azureTokenCredentials";
import { InvalidProviderOptions } from "../../utils/errors";

export default function useMicrosoft(env: EndpointExtensionContext["env"]) {
