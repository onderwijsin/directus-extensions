...
export function createLogger(logger?: LoggerLike): Logger {
	return {
		/**
		 * Logs a trace message through the supplied or console logger.
		...
		/**
		 * Logs a debug message through the supplied or console logger.
		 * @param message - Message to log.
		 * @param fields - Optional structured fields.
		 * @returns Nothing.
		 */
		...
		/**
		 * Logs an informational message through the supplied or console logger.
		 * @param message - Message to log.
		 * @param fields - Optional structured fields.
		 * @returns Nothing.
		 */
		...
		/**
		 * Logs a warning through the supplied or console logger.
		 * @param message - Message to log.
		 * @param fields - Optional structured fields.
		 * @returns Nothing.
		 */
		...
		/**
		 * Logs an error through the supplied or console logger.
		 * @param message - Message to log.
		 * @param fields - Optional structured fields.
		 * @returns Nothing.
		 */
