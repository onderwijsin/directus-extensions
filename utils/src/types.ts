...
interface BaseMetaCreate { event: 'items.create', collection: string }
interface BaseMetaUpdate { event: 'items.update', collection: string, keys: PrimaryKey[] } // Note that keys are NOT of type PrimaryKey. They get converted to string[] by Directus
interface BaseMetaDelete { event: 'items.delete', collection: string }
